                            ...
                            foreach ($our_solution__repeater as $index => $item) {
                                ...
                                <div class="our-solution-tab-content <?= $index === 0 ? 'active' : ''; ?>">
                                    <div class="our-solution-tab-content__left">
                                        ...
                                        <?php if (!empty($item['about_solution__link'])): ?>
                                            <a href="<?= esc_url( $item['about_solution__link']['url'] ); ?>" class="button button--read preview-solutions__button" <?php getLinkAttrs($item['about_solution__link']); ?>>
                                                <span><?= esc_html( $item['about_solution__link']['title'] ); ?></span>
