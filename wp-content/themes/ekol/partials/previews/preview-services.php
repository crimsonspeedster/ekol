<div class="preview-services">
    <a href="<?php the_permalink(); ?>" class="link preview-services__img">
        <?php getPostThumbnail(get_the_ID()); ?>
    </a>

    <a href="<?php the_permalink(); ?>" class="h4 link preview-services__title"><?php the_title(); ?></a>

    <?php
        if (has_excerpt()) {
            ?>
            <div class="content preview-services__content"><?php the_excerpt(); ?></div>
            <?php
        }
    ?>

    <a href="<?php the_permalink(); ?>" class="link link--more preview-services__link">
